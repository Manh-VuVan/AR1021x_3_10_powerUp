...
#define P2P_SEC_DEVICE_TYPES 5
	...
	/**
	 * p2p_sec_dev_type - Optional secondary device types
	 */
	u8 p2p_sec_dev_type[P2P_SEC_DEVICE_TYPES][8];

	/**
	 * p2p_num_sec_dev_types - Number of p2p_sec_dev_type entries
	 */
	size_t p2p_num_sec_dev_types;
#endif
...
#ifdef CONFIG_CUSTOM_WFD
/**
 * p2p_set_p2p_sec_dev_types - Set secondary device types
 * @p2p: P2P module context from p2p_init()
 * Returns: 0 on success, -1 on failure
 *
 * This function can be used to update the P2P module configuration with
