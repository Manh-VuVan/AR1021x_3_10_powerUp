...
struct wpa_driver_scan_params {
	...
	/**
	 * scan_band - band selection for scanning
	 *
	 * 0 - all bands
	 * 1 - 2.4GHz band only
	 * 2 - 5GHz band only
...
struct wpa_driver_ops {
  ...
  /**
	 * wlan_swow_cmd - execute driver-specific command
	 * @priv: private driver interface data
	 * @cmd: command to execute
	 * @buf: return buffer
	 * @buf_len: buffer length
	 ...
	 * Returns: 0 on success, negative (<0) on failure
	 */
	int (*wlan_swow_cmd)(void *priv, char *cmd, char *buf, size_t buf_len);

#endif//swow

	/**
	 * wlan_hb_cmd - execute driver-specific command
	 * @priv: private driver interface data
	 * @cmd: command to execute
	 * @buf: return buffer
	 * @buf_len: buffer length
	 ...
	 * Returns: 0 on success, negative (<0) on failure
	 */
	int (*wlan_hb_cmd)(void *priv, char *cmd, char *buf, size_t buf_len);
	...
	/**
	 * scan_cancel - to cancel scan request
	 * @priv: Private driver interface data
	 * Returns: 0 on success or -1 on failure
	 */
	int (*scan_cancel)(void *priv);

    /**
	 * wlan_debugfs_cmd - execute driver-debugfs command
	 * @priv: private driver interface data
	 * @cmd: command to execute
	 * @buf: return buffer
	 * @buf_len: buffer length
	 ...
	 * Returns: 0 on success, negative (<0) on failure
	 */
	int (*wlan_debugfs_cmd)(void *priv, char *cmd, char *buf, size_t buf_len);
