...
#define DEFAULT_P2P_SEARCH_DELAY 750
...
#define CFG_CHANGED_P2P_SEC_DEVICE_TYPE BIT(14)
...
#define MAX_SEC_DEVICE_TYPES 5
	...
	u8 p2p_sec_device_type[MAX_SEC_DEVICE_TYPES][WPS_DEV_TYPE_LEN];
	int p2p_num_sec_device_types;
#endif

	int p2p_listen_reg_class;
	int p2p_listen_channel;
	int p2p_listen_reg_class_backup;
	int p2p_listen_channel_backup;
...
#define MAX_WPS_VENDOR_EXT 10
	...
	/**
	 * p2p_join_timeout - join start timeout
	 */
	unsigned int p2p_join_timeout;
	...
	*/
	...
	u8 tx_power;
	/**
	 * scan_band - Skip 2GHz or 5GHz band scan
	 * This is used to skip 2GHz or 5GHz band scan while wpa_supplicant issue a full scan command.
	 * Ex: scan_band=1
	 */
	int scan_band;
