...
#define ATH_IOCTL_NF                   (IOCTL_PHYDEV_MASK | 10)       /* Device NF */  
...
typedef enum athcfg_wcmd_type{
	...
	ATHCFG_WCMD_GET_NF            = (ATH_IOCTL_NF            | IOCTL_GET_MASK),
}athcfg_wcmd_type_t;
...
typedef struct athcfg_wcmd_nf_list {
	int nf_ch0_master;
	int nf_ch0_extension;
	int nf_ch1_master;
	int nf_ch1_extension;
} athcfg_wcmd_nf_t;
/**
