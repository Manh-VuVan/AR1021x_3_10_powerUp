...
struct ath_hif_info_t ath_info;
/* pipe/urb operations */
...
#endif
        if (dev->manufacturer)
                memcpy(ath_info.manufacturer, dev->manufacturer,
                                sizeof(ath_info.manufacturer));
        if (dev->serial)
                memcpy(ath_info.serial, dev->serial,
                                sizeof(ath_info.serial));
