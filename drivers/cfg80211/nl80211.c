...
{
       if(nla_put_u32(msg, NL80211_FREQUENCY_ATTR_FREQ,chan->center_freq))//tkun add
		goto nla_put_failure;
	if ((chan->flags & IEEE80211_CHAN_DISABLED) && nla_put_flag(msg, NL80211_FREQUENCY_ATTR_DISABLED))
		goto nla_put_failure;
...
static int nl80211_put_iftypes(struct sk_buff *msg, u32 attr, u16 ifmodes)
{
	...
	i = 0;
	while (ifmodes) {
		if ((ifmodes & 1) && nla_put_flag(msg, i))//tkun add
		    goto nla_put_failure;
		ifmodes >>= 1;
		i++;
	}
...
static int nl80211_get_key(struct sk_buff *skb, struct genl_info *info)
{
	...
	if (mac_addr && nla_put(msg, NL80211_ATTR_MAC, ETH_ALEN, mac_addr))
		goto nla_put_failure;
...
static struct genl_ops nl80211_ops[] = {
	...
	},
	{
		...
		.internal_flags = NL80211_FLAG_NEED_NETDEV_UP |
				  NL80211_FLAG_NEED_RTNL,
//tkun .internal_flags = NL80211_FLAG_NEED_NETDEV->.internal_flags = NL80211_FLAG_NEED_NETDEV_UP
	},
	{
				 ...
				 u16 status, gfp_t gfp)
{
	...
	if(nla_put_u32(msg, NL80211_ATTR_WIPHY, rdev->wiphy_idx) ||
	   ...
	   (req_ie && nla_put(msg, NL80211_ATTR_REQ_IE, req_ie_len, req_ie)) ||
	   (resp_ie && nla_put(msg, NL80211_ATTR_RESP_IE, resp_ie_len, resp_ie)))
		goto nla_put_failure;//modify
	genlmsg_end(msg, hdr);
				 ...
				 const u8 *tsc, gfp_t gfp)
{
	...
	if (nla_put_u32(msg, NL80211_ATTR_WIPHY, rdev->wiphy_idx) ||
	    ...
	    (key_id != -1 && nla_put_u8(msg, NL80211_ATTR_KEY_IDX, key_id)) ||
